...
区别在哪？真正的 Agent 记忆至少需要五个能力，RAG 一个都没有完整解决：
...
Agent 记忆问题的完整解决还需要时间，但方向已经越来越清晰。
...
一句话收尾：**现阶段，记忆靠模型自带是死路。记忆必须工程化——外置化、结构化、分层化，再用 Harness 兜底。**
